...
```bash
python slerpmergelm.py "The-Face-Of-Goonery_Huginn-13b-v1.2" "Undi95_ReML-L2-13B" "ReMM"
```
6. You can also use in command line: python slerpmergelm.py "path model1" "path model2" "path result"
